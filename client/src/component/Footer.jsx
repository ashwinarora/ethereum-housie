        ...
        <nav id="footer" >
            {/* <div className="nav-wrapper grey darken-4 footer"> */}
                ...
                <div className="icon-div">
                    <a className="icons" style={{marginRight:"1rem"}} href="https://www.linkedin.com/in/ashwin-arora/" target="_blank">
                    ...
                    <a className="icons" href="https://github.com/ashwinarora/mern-social-network" target="_blank">
                        <svg style={{ width: "2rem", height: "2rem" }} viewBox="0 0 24 24">
